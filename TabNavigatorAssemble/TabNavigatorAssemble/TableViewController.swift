...
class TableViewController: UITableViewController {
    ...
    func appendData(){
        if TodoMessage.check == "New"{
            dataArray.append(TodoList(items: TodoMessage.items, itemsImageFile: TodoMessage.itemsImageFile))
            TodoMessage.check = "Old"
        }
    }
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "sgDetail"{
            ...
            //instance
            let detailView = segue.destination as! TableDetailViewController
            //데이터 넣어주기
