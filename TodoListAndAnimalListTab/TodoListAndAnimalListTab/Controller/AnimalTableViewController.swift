...
class AnimalTableViewController: UITableViewController {
    ...
    func appendData(){
        if AnimalMessage.check == "New"{
            dataArray.append(AnimalList(names: AnimalMessage.names, animalImageName: AnimalMessage.animalImageName, animalDetail: AnimalMessage.animalDetail))
            AnimalMessage.check = "Old"
        }
    }
